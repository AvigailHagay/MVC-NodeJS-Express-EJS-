...
The application is also connected to a database, which stores the users and their comments - relation. Users can add and delete comments on the images, and the application allows for dynamic updates to the page as comments are added or deleted. 
